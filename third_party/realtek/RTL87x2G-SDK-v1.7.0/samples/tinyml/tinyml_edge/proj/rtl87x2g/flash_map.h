...
example:
    ...
    5) OTA Bank0:                                      1112K (0x04012000)
        ...
        e) APP code                    800K (0x0405F000)
        f) APP Config File               4K (0x04127000)
        g) APP data1                     0K (0x04128000)
        h) APP data2                     0K (0x04128000)
        i) APP data3                     0K (0x04128000)
        j) APP data4                     0K (0x04128000)
        k) APP data5                     0K (0x04128000)
        l) APP data6                     0K (0x04128000)
    6) OTA Bank1:                                         0K (0x04128000)
    ...
    7) Bank0 Secure APP Code:                             0K (0x04128000)
    8) Bank0 Secure APP Data:                             0K (0x04128000)
    9) Bank1 Secure APP Code:                             0K (0x04128000)
    10) Bank1 Secure APP Data:                            0K (0x04128000)
    11) RO DATA1:                                         0K (0x04128000)
    12) RO DATA2:                                         0K (0x04128000)
    13) RO DATA3:                                         0K (0x04128000)
    14) RO DATA4:                                         0K (0x04128000)
    15) RO DATA5:                                         0K (0x04128000)
    16) RO DATA6:                                         0K (0x04128000)
    17) OTA Tmp:                                        800K (0x04128000)
    18) FTL:                                             16K (0x041F0000)
    19) user data1:                                       0K (0x041F4000)
    20) user data2:                                       0K (0x041F4000)
    21) user data3:                                       0K (0x041F4000)
    22) user data4:                                       0K (0x041F4000)
    23) user data5:                                       0K (0x041F4000)
    24) user data6:                                       0K (0x041F4000)
    25) user data7:                                       0K (0x041F4000)
    26) user data8:                                       0K (0x041F4000)
    27) APP Defined Section1:                             4K (0x041F4000)
    28) APP Defined Section2:                             0K (0x041F5000)
    29) MP RF Test Image:                                 0K (0x041F5000)
*/
