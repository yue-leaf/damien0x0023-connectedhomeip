...
example:
    ...
    5) OTA Bank0:                                       620K (0x04012000)
        ...
        e) APP code                    308K (0x0405F000)
        f) APP Config File               4K (0x040AC000)
        g) APP data1                     0K (0x040AD000)
        h) APP data2                     0K (0x040AD000)
        i) APP data3                     0K (0x040AD000)
        j) APP data4                     0K (0x040AD000)
        k) APP data5                     0K (0x040AD000)
        l) APP data6                     0K (0x040AD000)
    6) OTA Bank1:                                         0K (0x040AD000)
    ...
    7) Bank0 Secure APP Code:                             0K (0x040AD000)
    8) Bank0 Secure APP Data:                             0K (0x040AD000)
    9) Bank1 Secure APP Code:                             0K (0x040AD000)
    10) Bank1 Secure APP Data:                            0K (0x040AD000)
    11) RO DATA1:                                         0K (0x040AD000)
    12) RO DATA2:                                         0K (0x040AD000)
    13) RO DATA3:                                         0K (0x040AD000)
    14) RO DATA4:                                         0K (0x040AD000)
    15) RO DATA5:                                         0K (0x040AD000)
    16) RO DATA6:                                         0K (0x040AD000)
    17) OTA Tmp:                                        312K (0x040AD000)
    18) FTL:                                             16K (0x040FB000)
    19) user data1:                                       0K (0x040FF000)
    20) user data2:                                       0K (0x040FF000)
    21) user data3:                                       0K (0x040FF000)
    22) user data4:                                       0K (0x040FF000)
    23) user data5:                                       0K (0x040FF000)
    24) user data6:                                       0K (0x040FF000)
    25) user data7:                                       0K (0x040FF000)
    26) user data8:                                       0K (0x040FF000)
    27) APP Defined Section1:                             4K (0x040FF000)
...
#define BANK0_APP_SIZE                  0x0004D000  //308K Bytes
#define BANK0_APP_CONFIG_FILE_ADDR      0x040AC000
#define BANK0_APP_CONFIG_FILE_SIZE      0x00001000  //4K Bytes
#define BANK0_APP_DATA1_ADDR            0x040AD000
#define BANK0_APP_DATA1_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA2_ADDR            0x040AD000
#define BANK0_APP_DATA2_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA3_ADDR            0x040AD000
#define BANK0_APP_DATA3_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA4_ADDR            0x040AD000
#define BANK0_APP_DATA4_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA5_ADDR            0x040AD000
#define BANK0_APP_DATA5_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA6_ADDR            0x040AD000
