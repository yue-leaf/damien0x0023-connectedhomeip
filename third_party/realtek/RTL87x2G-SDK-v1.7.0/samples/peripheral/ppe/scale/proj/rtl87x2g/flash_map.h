...
example:
    ...
    5) OTA Bank0:                                       612K (0x04012000)
        ...
        c) BT Lowerstack Patch code     60K (0x0401B000)
        d) BT Host code                212K (0x0402A000)
        e) APP code                    304K (0x0405F000)
        f) APP data1                     0K (0x040AB000)
        g) APP data2                     0K (0x040AB000)
        h) APP data3                     0K (0x040AB000)
        i) APP data4                     0K (0x040AB000)
        j) APP data5                     0K (0x040AB000)
        k) APP data6                     0K (0x040AB000)
    6) OTA Bank1:                                         0K (0x040AB000)
        a) OTA Header                    0K (0x00000000)
        b) System Patch code             0K (0x00000000)
        c) BT Lowerstack Patch code      0K (0x00000000)
    ...
    20) APP Defined Section2:                             0K (0x04100000)
*/
...
#define BANK0_APP_SIZE                  0x0004C000  //304K Bytes
