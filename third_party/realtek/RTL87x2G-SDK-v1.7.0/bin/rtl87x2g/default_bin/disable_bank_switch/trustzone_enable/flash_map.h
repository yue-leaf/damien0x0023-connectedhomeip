...
example:
    ...
    5) OTA Bank0:                                       612K (0x04012000)
        ...
        e) APP code                    300K (0x0405F000)
        f) APP Config File               4K (0x040AA000)
        g) APP data1                     0K (0x040AB000)
        h) APP data2                     0K (0x040AB000)
        i) APP data3                     0K (0x040AB000)
        j) APP data4                     0K (0x040AB000)
        k) APP data5                     0K (0x040AB000)
        l) APP data6                     0K (0x040AB000)
    6) OTA Bank1:                                         0K (0x040AB000)
    ...
    7) Bank0 Secure APP Code:                            16K (0x040AB000)
    8) Bank0 Secure APP Data:                             0K (0x040AF000)
    9) Bank1 Secure APP Code:                             0K (0x040AF000)
    10) Bank1 Secure APP Data:                            0K (0x040AF000)
    11) RO DATA1:                                         0K (0x040AF000)
    12) RO DATA2:                                         0K (0x040AF000)
    13) RO DATA3:                                         0K (0x040AF000)
    14) RO DATA4:                                         0K (0x040AF000)
    15) RO DATA5:                                         0K (0x040AF000)
    16) RO DATA6:                                         0K (0x040AF000)
    17) OTA Tmp:                                        304K (0x040AF000)
...
#define OTA_BANK0_SIZE                  0x00099000  //612K Bytes
#define OTA_BANK1_ADDR                  0x040AB000
#define OTA_BANK1_SIZE                  0x00000000  //0K Bytes
#define BANK0_SECURE_APP_ADDR           0x040AB000
#define BANK0_SECURE_APP_SIZE           0x00004000  //16K Bytes
#define BANK0_SECURE_APP_DATA_ADDR      0x040AF000
#define BANK0_SECURE_APP_DATA_SIZE      0x00000000  //0K Bytes
#define BANK1_SECURE_APP_ADDR           0x040AF000
#define BANK1_SECURE_APP_SIZE           0x00000000  //0K Bytes
#define BANK1_SECURE_APP_DATA_ADDR      0x040AF000
#define BANK1_SECURE_APP_DATA_SIZE      0x00000000  //0K Bytes
#define RO_DATA1_ADDR                   0x040AF000
#define RO_DATA1_SIZE                   0x00000000  //0K Bytes
#define RO_DATA2_ADDR                   0x040AF000
#define RO_DATA2_SIZE                   0x00000000  //0K Bytes
#define RO_DATA3_ADDR                   0x040AF000
#define RO_DATA3_SIZE                   0x00000000  //0K Bytes
#define RO_DATA4_ADDR                   0x040AF000
#define RO_DATA4_SIZE                   0x00000000  //0K Bytes
#define RO_DATA5_ADDR                   0x040AF000
#define RO_DATA5_SIZE                   0x00000000  //0K Bytes
#define RO_DATA6_ADDR                   0x040AF000
#define RO_DATA6_SIZE                   0x00000000  //0K Bytes
#define OTA_TMP_ADDR                    0x040AF000
#define OTA_TMP_SIZE                    0x0004C000  //304K Bytes
...
#define BANK0_APP_SIZE                  0x0004B000  //300K Bytes
#define BANK0_APP_CONFIG_FILE_ADDR      0x040AA000
#define BANK0_APP_CONFIG_FILE_SIZE      0x00001000  //4K Bytes
#define BANK0_APP_DATA1_ADDR            0x040AB000
#define BANK0_APP_DATA1_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA2_ADDR            0x040AB000
#define BANK0_APP_DATA2_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA3_ADDR            0x040AB000
#define BANK0_APP_DATA3_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA4_ADDR            0x040AB000
#define BANK0_APP_DATA4_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA5_ADDR            0x040AB000
#define BANK0_APP_DATA5_SIZE            0x00000000  //0K Bytes
#define BANK0_APP_DATA6_ADDR            0x040AB000
