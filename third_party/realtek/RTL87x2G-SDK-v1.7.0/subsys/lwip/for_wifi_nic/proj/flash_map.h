...
example:
    ...
    5) OTA Bank0:                                      2356K (0x04012000)
        ...
        e) APP code                   2048K (0x0405F000)
        f) APP data1                     0K (0x0425F000)
        g) APP data2                     0K (0x0425F000)
        h) APP data3                     0K (0x0425F000)
        i) APP data4                     0K (0x0425F000)
        j) APP data5                     0K (0x0425F000)
        k) APP data6                     0K (0x0425F000)
    6) OTA Bank1:                                         0K (0x0425F000)
    ...
    7) Bank0 Secure APP Code:                            16K (0x0425F000)
    8) Bank0 Secure APP Data:                             0K (0x04263000)
    9) Bank1 Secure APP Code:                             0K (0x04263000)
    10) Bank1 Secure APP Data:                            0K (0x04263000)
    11) RO DATA1:                                         0K (0x04263000)
    12) RO DATA2:                                         0K (0x04263000)
    13) RO DATA3:                                         0K (0x04263000)
    14) RO DATA4:                                         0K (0x04263000)
    15) RO DATA5:                                         0K (0x04263000)
    16) RO DATA6:                                         0K (0x04263000)
    17) OTA Tmp:                                       2048K (0x04263000)
    18) FTL:                                             16K (0x04463000)
    19) APP Defined Section1:                             4K (0x04467000)
    20) APP Defined Section2:                             0K (0x04468000)
*/
...
#define FLASH_MAX_SIZE                  0x01000000  //16384K Bytes
