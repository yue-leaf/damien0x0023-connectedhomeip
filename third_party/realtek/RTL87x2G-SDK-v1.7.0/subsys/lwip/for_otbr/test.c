 ...
 *                              Local Variables
 *============================================================================*/
#if ((TEST_MODE == NETCONN_JPERF_CLENT_TEST) || (TEST_MODE == NETCONN_JPERF_SERVER_TEST))
...
#elif (TEST_MODE == NETCONN_JPERF_CLENT_TEST)
    struct netconn *conn = NULL;
    int i;
    int ret;
    uint8_t *send_buf;
...
void test_init(void)
{
    sys_thread_new("test_thread", test_thread, NULL, 2048, 4);
}
