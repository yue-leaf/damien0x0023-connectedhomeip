...
void eth_init_data(void)
{
    ...
    DBG_DIRECT("[eth_init_data] in eth_init_data func");
    ...
    if (pTmpTxDesc == NULL || pTmpRxDesc == NULL || pTmpTxPktBuf == NULL || pTmpRxPktBuf == NULL)
    {
        ...
        DBG_DIRECT("[eth_init_data] TX/RX descriptor malloc fail");
        return;
    }
...
void eth_init_bsp_driver(void)
{
    ...
    DBG_DIRECT("[eth_init_bsp_driver]");
...
void eth_init_driver(void)
{
    ...
    DBG_DIRECT("[eth_init_driver]");
    RamVectorTableUpdate_ext(ETH_VECTORn, ETH_Handler);
    ...
    eth_init_bsp_driver();
    DBG_DIRECT("[eth_init_driver] end");
}
